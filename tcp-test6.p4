                 ...
                 inout standard_metadata_t stdmeta)
{
    ...
    action to_port_action(bit<48> dst_mac,bit<32> dst_ip, bit<32> src_ip, bit<16> port){
    ...
    action send_to_nat(bit<48> src_mac,bit<48> dst_mac,bit<32> src_ip, bit<32> dst_ip, bit<16> port){
